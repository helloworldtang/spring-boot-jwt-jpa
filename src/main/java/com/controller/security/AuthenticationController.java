...
public class AuthenticationController {
    ...
    public ResponseEntity<?> createAuthenticationToken(@Valid @ModelAttribute JwtAuthenticationReq authenticationRequest, Device device) throws AuthenticationException {
